...
| Goodie and 90-day claim | Button appears only when every bar is full; server re-checks; one claim per program | Automated (criteria never met in demo data) |
